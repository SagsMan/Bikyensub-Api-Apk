<?php
/**
 * Firebase Cloud Messaging (FCM) HTTP v1 API Helper — Bikyensub
 ...
 * 2. Both adildata and bikyensub share the same Firebase project: vtu-apps-5c6af
 */
...
// Legacy alias — used by webhook.php
function send_fcm_notification($fcm_token, $title, $body, $data = []) {
    return fcm_send_to_token($fcm_token, $title, $body, $data);
}
